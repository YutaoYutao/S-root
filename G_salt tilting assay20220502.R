...
setwd("~/Desktop")
Data <- read.csv("GWAS_titling_FullDataSet.csv")
Data$Genotype <- factor(Data $ Genotype, level=c ("Col-0","pk-1","pk-2", "exad-1", "exad-2", "gor-1", "adss-1"))
Data$H <- factor(Data$H, level= c( "24", "48","72"))
Data$Treatment <- factor(Data $ Treatment, level=c("Control", "100mM NaCl"))
Data$interaction <- interaction(Data $ Genotype, Data$H, Data$Treatment, Data$Plate)


# new
require(ggplot2)
p <- ggplot(Data, aes(x = Treatment, y= vector_angle* -1,fill = Genotype)) + geom_boxplot(outlier.colour = NA)   + scale_fill_manual(values = c("Col-0" = "palegreen3","pk-1" = "rosybrown1", "pk-2"= "rosybrown3", "exad-1" = "steelblue1", "exad-2" = "steelblue3", "gor-1" = "gold2", "adss-1" = "lightyellow"))  + ylab("Root Vector Angle (degree)") + scale_x_discrete(limits= c())
...
contrasts<- c("Col0.0.24 - exad1.0.24 = 0",
              ...
              "Col0.0.24 - exadCP.0.24= 0",
              "Col0.0.24 - rlk1rlk2.0.24 = 0",
              "Col0.100.24 - exad1.100.24 = 0",
              "Col0.100.24 - exad2.100.24 = 0",
              "Col0.100.24 - exadCP.100.24= 0",
              "Col0.100.24 - rlk1rlk2.100.24 = 0",
              "Col0.0.48 - exad1.0.48 = 0",
              "Col0.0.48 - exad2.0.48 = 0",
              "Col0.0.48 - exadCP.0.48= 0",
              "Col0.0.48 - rlk1rlk2.0.48 = 0",
              "Col0.100.48 - exad1.100.48 = 0",
              "Col0.100.48 - exad2.100.48 = 0",
              "Col0.100.48 - exadCP.100.48= 0",
              "Col0.100.48 - rlk1rlk2.100.48 = 0",
              "Col0.0.72 - exad1.0.72 = 0",
              "Col0.0.72 - exad2.0.72 = 0",
              "Col0.0.72 - exadCP.0.72= 0",
              "Col0.0.72 - rlk1rlk2.0.72 = 0",
              "Col0.100.72 - exad1.100.72 = 0",
              "Col0.100.72 - exad2.100.72 = 0",
              "Col0.100.72 - exadCP.100.72= 0",
              "Col0.100.72 - rlk1rlk2.100.72 = 0")
...
qqnorm(Data$av_node_angle)
qqline(Data$av_node_angle)

require(nlme)
Model <- lme(fixed=av_node_angle~Line*Condition,random=~1|Plate, data = Data)
anova(Model)
summary(Model)
...
Model <- lm(av_node_angle~int, Data)
anova(Model)

require(multcomp)
contrasts<- c("Col.0.24 - G1.0.24 = 0",
              "Col.0.24 - G2.0.24 = 0",
              "Col.0.24 - G3.0.24= 0",
              "Col.0.24 - G4.0.24 = 0",
              "Col.0.24 - G5.0.24 = 0",
              "Col.0.24 - G7.0.24 = 0",
              "Col.100.24 - G1.100.24 = 0",
              "Col.100.24 - G2.100.24 = 0",
              "Col.100.24 - G3.100.24= 0",
              "Col.100.24 - G4.100.24 = 0",
              "Col.100.24 - G5.100.24 = 0",
              "Col.100.24 - G7.100.24 = 0",
              "Col.0.48 - G1.0.48 = 0",
              "Col.0.48 - G2.0.48 = 0",
              "Col.0.48 - G3.0.48= 0",
              "Col.0.48 - G4.0.48 = 0",
              "Col.0.48 - G5.0.48 = 0",
              "Col.0.48 - G7.0.48 = 0",
              "Col.100.48 - G1.100.48 = 0",
              "Col.100.48 - G2.100.48 = 0",
              "Col.100.48 - G3.100.48= 0",
              "Col.100.48 - G4.100.48 = 0",
              "Col.100.48 - G5.100.48 = 0",
              "Col.100.48 - G7.100.48 = 0",
              "Col.0.72 - G1.0.72 = 0",
              "Col.0.72 - G2.0.72 = 0",
              "Col.0.72 - G3.0.72= 0",
              "Col.0.72 - G4.0.72 = 0",
              "Col.0.72 - G5.0.72 = 0",
              "Col.0.72 - G7.0.72 = 0",
              "Col.100.72 - G1.100.72 = 0",
              "Col.100.72 - G2.100.72 = 0",
              "Col.100.72 - G3.100.72= 0",
              "Col.100.72 - G4.100.72 = 0",
              "Col.100.72 - G5.100.72 = 0",
              "Col.100.72 - G7.100.72 = 0")
summary(glht(Model, linfct = mcp(int = contrasts)))
